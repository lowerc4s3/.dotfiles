...
function __icon_map() {
   ...
   "Live")
        icon_result=":ableton:"
        ;;
   "Activity Monitor" | "Мониторинг системы")
   ...
   "BusyCal")
        icon_result=":busycal:"
        ;;
   "Calculator" | "Calculette" | "Калькулятор")
        icon_result=":calculator:"
        ;;
   "Calendar" | "日历" | "Fantastical" | "Cron" | "Amie" | "Calendrier" | "カレンダー" | "Notion Calendar" | "Календарь")
   ...
   "Cold Turkey Blocker")
        ...
        ;;
   "Color Picker" | "数码测色计" | "Цифровой колориметр")
   ...
   "Fusion")
        icon_result=":fusion:"
        ;;
   "System Preferences" | "System Settings" | "系统设置" | "Réglages Système" | "システム設定" | "Системные настройки")
        icon_result=":gear:"
        ;;
   "Ghostty")
        icon_result=":ghostty:"
   ...
   "Mullvad Browser")
        ...
        ;;
   "Music" | "音乐" | "Musique" | "ミュージック" | "Музыка")
        icon_result=":music:"
        ;;
   "Neovide" | "neovide")
        icon_result=":neovim:"
   ...
   "Passwords" | "Пароли")
        ...
        ;;
   "Preview" | "预览" | "Skim" | "zathura" | "Zathura" | "Aperçu" | "プレビュー" | "Просмотр")
        icon_result=":pdf:"
        ;;
   "PDF Expert")
   ...
   "Reeder")
        icon_result=":reeder5:"
        ;;
   "Reminders" | "提醒事项" | "Rappels" | "リマインダー" | "Напоминания")
